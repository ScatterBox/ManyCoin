...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "manycoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"manycoin.org", "dnsseed.manycoin.org"},
...
//    {"manycoinpool.org", "dnsseed.manycoinpool.org"},
...
//    {"manycointools.com", "testnet-seed.manycointools.com"},
//    {"weminemnc.com", "testnet-seed.weminemnc.com"},
    {"manycoin.carpenter-farms.us", "dnsseed.carpenter-farms.us"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. manycoin is probably already running."), addrBind.ToString().c_str());
        else
